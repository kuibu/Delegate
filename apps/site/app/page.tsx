...
const copy = {
  zh: {
    ...
    heroLead:
      "Delegate 是 AMN 的第一条可运行楔子：一个 Telegram-native 数字代表，用公开知识、安全边界、付费续用和人工升级，证明 Agent 可以成为可充值、可治理、可持续收益的公开服务入口。",
    heroPrimary: "查看数字代表",
    heroSecondary: "进入控制台",
    shipsKicker: "当前闭环",
    shipsTitle: "公开页、Telegram gateway、owner inbox、Stars 续费、早期钱包状态和 OpenViking 记忆层。",
    ...
    economyLead: "当前 Delegate 只交付 Telegram Stars 与早期钱包/发票视图；统一 AMN Pay、提现和 Merkle proof 是后续网络层。",
    economyPlans: [
      { name: "Agent Wallet", detail: "余额绑定到具体 Agent / Digital Representative，而不是平台大池子。", kicker: "钱包" },
      { name: "AMN Pay", detail: "未来从 Web、Telegram、WhatsApp、飞书、企业微信和 App 拉起统一充值页。", kicker: "充值入口" },
    ...
    roadmapStages: [
      { eyebrow: "Reference wedge", title: "Delegate", body: "公开数字代表、trust boundary、Telegram Stars、paid continuation 和 human escalation 已经能形成第一条交易闭环。" },
      { eyebrow: "AMN Pay target", title: "Unified recharge", body: "Web、Telegram、WhatsApp、飞书、企业微信和 App 只负责入口，统一充值页负责 Agent Wallet 入账。" },
  ...
  en: {
    ...
    heroLead:
      "Delegate is the first working AMN wedge: a Telegram-native Digital Representative that uses public knowledge, explicit trust boundaries, paid continuation, and human escalation to prove Agents can become rechargeable, governable, revenue-generating service surfaces.",
    heroPrimary: "Explore digital representative",
    heroSecondary: "Open control plane",
    shipsKicker: "What ships",
    shipsTitle: "Public page, Telegram gateway, owner inbox, Stars continuation, early wallet state, OpenViking memory.",
    ...
    economyLead: "Delegate currently ships Telegram Stars plus early wallet and invoice views. Unified AMN Pay, withdrawals, and Merkle proofs are future network layers.",
    economyPlans: [
      ...
      { name: "AMN Pay", detail: "Future Web, Telegram, WhatsApp, Feishu, WeCom, and app entry points open one unified recharge page.", kicker: "Recharge entry" },
    ...
    roadmapStages: [
      { eyebrow: "Reference wedge", title: "Delegate", body: "A public Digital Representative with trust boundaries, Telegram Stars, paid continuation, and human escalation already proves the first transaction loop." },
      { eyebrow: "AMN Pay target", title: "Unified recharge", body: "Web, Telegram, WhatsApp, Feishu, WeCom, and apps become entry points while one recharge page credits the Agent Wallet." },
